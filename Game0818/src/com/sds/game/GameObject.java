/*
 화면에 등장할 모든 게임 오브젝트가 반드시 구현해야할 메서드와 필요한 속성을 정의하기 위한 최상위클래스
 */
...
public abstract class GameObject {
	...
	//클래스 패스상에 존재하는 이미지명만으로 Image객체를 반환해주는 메서드
	...
	//Rectangle 객체가 생성은 되었지만, 눈에 보여지지는 않으므로, 개발시에만 시각화 시킬수있는 메서드 정의..
	//개발 후에는 호출X
